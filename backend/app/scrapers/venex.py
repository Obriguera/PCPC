...
from webdriver_manager.chrome import ChromeDriverManager  # Solo para local
# NO NECESITAS webdriver_manager CUANDO LO INSTALAS CON APT-GET
# from webdriver_manager.chrome import ChromeDriverManager # Comenta o elimina esta línea
...
def get_driver():
    ...
    options.add_argument("--no-sandbox")  # importante para Docker/Linux sin GUI
